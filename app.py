...
credential = ManagedIdentityCredential(client_id="74e39ec0-0a9a-4df5-9e20-059c8a392e89")
...
username_db = secret_client.get_secret("Server-Username").value
db_secret = secret_client.get_secret("Server-Password").value
